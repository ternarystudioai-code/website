  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-bold">1.0.2-stable.1</h1>
        <p className="text-lg text-gray-600 dark:text-gray-400">
          Beta release with experimental features
        </p>
        <p className="text-sm text-gray-500">
          Ternary v1.0.2-stable.1 includes experimental features and improvements for testing.
        </p>
      </div>
        ...
        <div className="mx-auto my-2 max-w-3xl rounded-xl overflow-hidden border border-gray-200 dark:border-gray-800 shadow-lg">
          <div className="relative w-full aspect-video">
            <iframe
              ...
              loading="lazy"
              title="Ternary 1.0.2-stable.1 Feature Demo"
